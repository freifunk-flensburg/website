...
?>
    <head>
        <link rel="stylesheet" href="firmware-downloader/assets/stylesheets/style.css">
        <link rel="apple-touch-icon" href="assets/images/apple-touch-icon-precomposed.png"/>
        <link href="firmware-downloader/assets/images/favicon.ico" rel="icon" type="image/x-icon" />
        <meta charset="utf-8">
    </head>
