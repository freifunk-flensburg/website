...
Wenn du uns regelmäßig unterstützen möchtest kannst du auch ein Fördermitglied im <?=$config['verein']['content']?> oder Chaostreff <?=$region?> werden.
Wende dich für weitere Informationen bitte mit einer <a target="_blank" href="<?=$config['email']['url']?>">Mail an uns</a>.</p>

<h4>Hohe Gebäude gesucht</h4>
<p>Um unser Freifunknetz in <?=$region?> weiter auszubauen wollen wir hoch hinaus. Hierzu suchen wir hohe Gebäude mit guter
...
schicke eine Mail an <a target="_blank" href="mailto:<?=$config['email']['url']?>"><?=$config['email']['content']?></a>.</p>
