<form class="participate_download-form" id="download-form">
    ...
    <div class="select-field">
        <select id="download-form-router">
            ...
            <option value="gluon-fffl-<?php echo $versionNumber; ?>-buffalo-wzr-hp-ag300h-wzr-600dhp">Buffalo WZR HP AG300H WZR 600DHP</option>
            <option value="gluon-fffl-<?php echo $versionNumber; ?>-buffalo-wzr-hp-g450h">Buffalo WZR HP G450H</option>
            ...
            <option value="gluon-fffl-<?php echo $versionNumber; ?>-tp-link-cpe210-v1.0">TP-Link CPE210 Ver:1.0</option>
            <option value="gluon-fffl-<?php echo $versionNumber; ?>-tp-link-cpe220-v1.0">TP-Link CPE220 Ver:1.0</option>
            <option value="gluon-fffl-<?php echo $versionNumber; ?>-tp-link-cpe510-v1.0">TP-Link CPE510 Ver:1.0</option>
            <option value="gluon-fffl-<?php echo $versionNumber; ?>-tp-link-cpe520-v1.0">TP-Link CPE520 Ver:1.0</option>
            ...
            <option value="gluon-fffl-<?php echo $versionNumber; ?>-tp-link-tl-mr3040-v2">TP-Link TL MR 3040 Ver:2</option>
            ...
            <option value="gluon-fffl-<?php echo $versionNumber; ?>-tp-link-tl-wa750re-v1">TP-Link TL WA750RE Ver:1</option>
            <option value="gluon-fffl-<?php echo $versionNumber; ?>-tp-link-tl-wa801n-nd-v2">TP-Link TL WA801 N/ND Ver:2</option>
            <option value="gluon-fffl-<?php echo $versionNumber; ?>-tp-link-tl-wa850re-v1">TP-Link TL WA850RE Ver:1</option>
            ...
            <option value="gluon-fffl-<?php echo $versionNumber; ?>-tp-link-tl-wr1043n-nd-v2">TP-Link TL WR 1043 N/ND Ver:2</option>
