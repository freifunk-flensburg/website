<form class="participate_download-form" id="download-form">
    ...
    <div class="select-field">
        <select id="download-form-router">
            ...
            <option value="-tp-link-cpe210-v1.0">TP-Link CPE210 Ver:1.0</option>
            <option value="-tp-link-cpe220-v1.0">TP-Link CPE220 Ver:1.0</option>
            <option value="-tp-link-cpe510-v1.0">TP-Link CPE510 Ver:1.0</option>
            <option value="-tp-link-cpe520-v1.0">TP-Link CPE520 Ver:1.0</option>
